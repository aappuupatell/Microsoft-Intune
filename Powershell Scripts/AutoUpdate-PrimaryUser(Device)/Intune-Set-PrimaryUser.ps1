...
# Customizations
$Enrollmentaccounts = @("") # @() = No Enrollment accounts. @("") = will filter them out and not assign them as primary users.
$AzureAutomation = $False                # $True = The script will be executed in Azure Automation. $False The script will be executed manually 
$ExecutionMode = ""                 # "Test" = No changes will be made on Primary owner, "Prod" = Primary Owner will be changes
